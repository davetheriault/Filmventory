...
public class InstaAPI extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String callBackUrl = requestUrl.substring(0, lastSlashIndex) + "/InstaBack";
        
        String imageDirectory = "pics/";

        response.sendRedirect("https://api.instagram.com/oauth/authorize/?client_id=" + clientID + "&redirect_uri=" + callBackUrl + "&response_type=code");
    }
